...
class KNearestNeighbor(object):
    ...
    def compute_distances_no_loops(self, X):
        ...
        # dists = np.sum(((self.X_train - X) ** 2), axis=1) ** 0.5
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            # closest_y = (list((zip((dists[i]), (self.y_train)))))
            # closest_y = sorted(closest_y, key=lambda tup: tup[0])
            # closest_y = closest_y[:k][0][1]
